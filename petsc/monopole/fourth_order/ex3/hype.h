...
typedef struct{
  ...
  PetscInt  Nk;                      /* total no of cells on Kirchhoff semi-circular arc */
  PetscReal dtheta;                  /* angle difference between two quad points */ 
  PetscInt  Nk_local;                /* no of quadrature points in the current process*/
...
PetscErrorCode ComputePressureAverage(Vec, DM, PetscReal, AppCtx);
