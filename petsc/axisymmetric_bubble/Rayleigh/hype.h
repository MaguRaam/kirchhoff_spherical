...
static const PetscReal g1            = 4.4;     /* Stiffness constant of the liquid phase */
static const PetscReal g2            = 1.4;     /* Stiffness constant of the gas phase */
static const PetscReal p1            = 600.0;   /* Specific heat ratio of the liquid phase */
static const PetscReal p2            = 0.0;     /* Specific heat ratio of the gas phase */
static const PetscReal p0            = 1.0;     /* Initial pressure outside the bubble*/
...
static const PetscReal R0             = 1.0;    /* Bubble radius*/
