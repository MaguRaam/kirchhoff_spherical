...
static const PetscReal p1            = 6.0e8;   /* Specific heat ratio of the solid phase */
static const PetscReal p2            = 0.0;     /* Specific heat ratio of the gas phase */
static const PetscReal p0            = 101325.0;/* Initial pressure outside the bubble*/
...
static const PetscReal R0            = 6.0e-5;  /* Bubble radius */

static const PetscReal beta_d        = 9.1e5;   /* decay constant */
static const PetscReal frequency     = 83.3e3;  /* frequency */ 
static const PetscReal P_s           = 60.0e6;  /* shock amplitude */
