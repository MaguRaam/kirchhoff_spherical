...
//Note: density is scaled by 1000 and pressure is scaled by 1e^5:
...
static const PetscReal p0            = 10.;     /* Initial pressure outside the bubble*/
...
static const PetscReal R0             = 0.25;   /* Bubble radius*/
...
PetscReal WriteKirchhoffData(Vec, DM, AppCtx*, PetscReal);
