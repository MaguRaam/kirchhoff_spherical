...
template <int npts>
double lagrange_derivative(const std::array<double, npts> &t, const std::array<double, npts> &p, double tau)
{
    std::array<double, npts> basis;
...
// create grid:
std::vector<double> create_grid(double xmin, double xmax, int ncells)
{
